...
public class polygon_profit_calculator extends AppCompatActivity {
    EditText editText1, editText2, editText3;
    Button button;
    TextView textView;
    float edt1, edt2, edt3;
    float totalCoins,profit,increment= (float) 28.88,finalPrice;
    String text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_polygon_profit_calculator);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                text = String.format("You are purchasing- %.2f Polygon \n After %.0f years. Your profit will be- Rs.%.2f \n Total amount of your Polygon will be Rs.%.2f ",totalCoins,edt3,profit,finalPrice);
