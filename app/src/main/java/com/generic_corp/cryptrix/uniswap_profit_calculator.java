...
public class uniswap_profit_calculator extends AppCompatActivity {

    EditText editText1, editText2, editText3;
    Button button;
    TextView textView;
    float edt1, edt2, edt3;
    float totalCoins,profit,increment= (float) 611.72,finalPrice;
    String text;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_uniswap_profit_calculator);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                text = String.format("You are purchasing- %.2f Uniswap \n After %.0f years. Your profit will be- Rs.%.2f \n Total amount of your Uniswap will be Rs.%.2f ",totalCoins,edt3,profit,finalPrice);
